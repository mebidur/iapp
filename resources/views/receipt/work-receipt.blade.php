		...
		<div class="col-md-6"><br>
			<div class="row">
				...
				<div class="col-md-6 col-md-6 col-xs-6 col-sm-6"><p></p>
					<button type="submit" ng-disabled="workReceiptForm.$invalid" class="btn btn-primary btn-block input-lg work-invoice-btn iapp-lg-btn choices-holder" data-loading-text="Please wait ...">Continue ...</button>
				</div>
			</div>
		</div>
	</div>
